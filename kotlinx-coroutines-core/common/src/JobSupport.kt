...
public open class JobSupport constructor(active: Boolean) : Job, ChildJob, ParentJob, SelectClause0 {
     ...
     */
    fun initParentJobInternal(parent: Job?) {
...
internal val SEALED = Symbol("SEALED")

@SharedImmutable
@JvmField // JvmField + internal avoids generation of accessors
internal val EMPTY_NEW = Empty(false)

@SharedImmutable
@JvmField // JvmField + internal avoids generation of accessors
internal val EMPTY_ACTIVE = Empty(true)

internal class Empty(override val isActive: Boolean) : Incomplete {
